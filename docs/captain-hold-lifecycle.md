...
Retention prunes a closed row out of the live backlog into the configured archive, so a recorded captain answer routinely outlives the row's presence there.
